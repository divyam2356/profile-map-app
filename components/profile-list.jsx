            ...
            <Card key={profile.id} className="overflow-hidden bg-gray-800 border-gray-700 hover:border-blue-600 transition-colors">
              ...
              <CardFooter className="flex justify-between p-4 pt-0">
                <Button 
                  ...
                  className="border-gray-600 bg-[#004687] text-gray-200 hover:bg-blue-900/40 hover:text-white hover:border-blue-500"
                >
                  <MapPin className="mr-2 h-4 w-4" />
                  Show on Map
                </Button>
                <Link href={`/profile/${profile.id}`}>
                  <Button size="sm" className="bg-blue-600 text-white hover:bg-blue-700">View Profile</Button>
                </Link>
              </CardFooter>
            </Card>
          ))}
